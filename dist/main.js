...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header */ \"./src/header.js\");\n/* harmony import */ var _about__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./about */ \"./src/about.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n(0,_header__WEBPACK_IMPORTED_MODULE_0__.createHeader)();\n(0,_about__WEBPACK_IMPORTED_MODULE_1__.createAbout)();\n\nfunction emptyContainer() {\n    const container = document.querySelector('#container');\n    container.innerHTML = '';\n}\n\n\n/*\n\n\nCreate a bare-bones homepage for a restaurant. Include an image, headline, and some copy about how wonderful the restaurant is. It’s okay to hard-code \nthese into the HTML for now just to see how they look on the page.\n\nNow remove those elements from the HTML (so leave only the <html>, <body>, and <div id=\"content\"> tags) and instead create them by using JavaScript only, \ne.g. by appending each new element to div#content once the page is first loaded. Since we’re all set up to write our code in multiple files, let’s write this \ninitial page-load function inside of its own module and then import and call it inside of index.js.\n\nNext, set up your restaurant site to use tabbed browsing to access the Contact and Menu pages. Look at the behavior of this student solution for \nvisual inspiration.\n\nPut the contents of each ‘tab’ inside of its own module. Each module will export a function that creates a div element, adds the appropriate content and styles to \nthat element and then appends it to the DOM.\n\nWrite the tab-switching logic inside of index.js. You should have event listeners for each tab that wipes out the current contents and then \nruns the correct ‘tab module’ to populate it again.\n\n*/\n\n/*\nMain: Imports and call functions for website container and 3x tab modules\n\nContainer module:\n    Create nodes\n    Add content and style to nodes\n    Append nodes to DOM\n    Export function\n\nTab module about:\n    Create nodes\n    Add content and style to nodes\n    Append nodes to DOM\n    Export function\n\nTab module menu:\n    Create nodes\n    Add content and style to nodes\n    Append nodes to DOM\n    Export function\n\nTab module contact:\n    Create nodes\n    Add content and style to nodes\n    Append nodes to DOM\n    Export function\n\n\n*/ \n\n\n\n\n\n\n\n//# sourceURL=webpack://restaurant/./src/index.js?");
